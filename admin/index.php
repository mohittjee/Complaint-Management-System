...
<body>
	...
	<div class="footer">
		<div class="container">
			...
			<b class="copyright">&copy; 2024 CampusConnect </b> All rights reserved.
		</div>
	</div>
	...
	<!-- <script>
        $.backstretch("assets/images/Blue Red Geometric Fitness Program Landing Page Website.png", {speed: 500});
    </script> -->
</body>