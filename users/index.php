...
<html lang="en">
  <head>
    ...
    <title>Campus Connect | User Login</title>
		...
		<div class="navbar-inner">
			<div class="container" style="margin-top: 10px;">
				<a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
			  	...
			  	<a class="brand" href="" style="font-size: 20px; color: black; text-align: left;">
			  		CampusConnect | Admin
			  	</a>
				...
				<div class="nav-collapse collapse navbar-inverse-collapse">
					...
					<ul class="nav pull-right">
						...
						<li><a href="https://campusconnectcms.000webhostapp.com/" style="color:black;">
						Back to Portal
...
echo htmlentities($msg);
    ...
    <script>
        $.backstretch("assets/img/Blue Red Geometric Fitness Program Landing Page Website.png", {speed: 500});
    </script>
